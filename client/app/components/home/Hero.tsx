...
const Hero = (props: Props) => {
  return (
    <section
      className={`w-screen md:h-screen flex md:flex-row flex-col md:justify-between lg:items-center overflow-x-hidden ${styles.paddingX} xl:mt-10 mt-30 md:gap-10 `}
    >
      {/* content */}
      <motion.div
