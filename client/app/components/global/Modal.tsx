...
const Modal: FC<Props> = ({ mode, setOpenModal, setMode }) => {
  return (
    <section className=" bg-yellow-400 ">
      ...
      />
      <div className="  bg-white absolute md:fixed top-[20px] md:top-[50px] h-fit md:h-[550px] left-[5%] w-[90%] xl:left-[15%] xl:w-[70%] md:left-[7.5%] md:max-w-[85%] z-20 rounded-3xl md:flex items-center overflow-hidden">
        <div className=" flex justify-end items-end md:w-[250px] xl:w-[548px] h-[10px] w-full md:h-full bg-primary rounded-tl-3xl rounded-bl-3xl relative overflow-clip md:p-6">
          {/* logo */}
          ...
          {/* text */}
          <h2 className=" hidden md:block text-white  lg:text-2xl lg:text-center max-w-[300px] mx-auto mt-10">
