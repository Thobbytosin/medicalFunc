...
const Search = (props: Props) => {
  ...
  return (
    <div
      className={`${styles.marginX} -mt-5 md:-mt-24 lg:-mt-2 xl:-mt-20 mb-10 w-[80%] md:w-[70%] lg:w-[75%] xl:w-[70%] bg-white shadow shadow-black/20  rounded-4xl p-4 lg:p-8  relative z-10`}
    >
      ...
      <form>
        <input
          ...
          className=" bg-[#DEDEDE] w-[120px] md:w-[180px] lg:w-[278px] lg:rounded-xl rounded-lg p-1.5 lg:p-3 lg:text-base text-xs outline-none focus:ring-1 focus:ring-primary focus:border-primary/50 text-[#5B5B5B]"
        />
        <select
          title="Speciality"
          name="speciality"
          ...
          onChange={handleChange}
          className=" bg-[#dedede] w-[120px] md:w-[180px] lg:w-[278px] lg:rounded-xl rounded-lg p-1.5 lg:p-3 lg:text-base text-xs outline-none focus:ring-1 focus:ring-primary focus:border-primary/50 text-[#5B5B5B] ml-1 md:ml-3"
        >
